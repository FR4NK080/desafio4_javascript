...
const propiedades = document.querySelector("#principal");

buscar.addEventListener("click",() =>{
  const cuartos = document.querySelector("#cuartos").value;
  const metrosMin = document.querySelector("#desde").value;
  const metrosMax = document.querySelector("#hasta").value;
  ...
  for (let propiedad of propiedadesJSON) {
    if(propiedad.rooms == cuartos && propiedad.m >= metrosMin && propiedad.m <= metrosMax){
      console.log("cumple las condiciones",propiedad);
